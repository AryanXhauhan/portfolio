...
const Achievements = () => {
  ...
  return (
    ...
    >
      ...
      {!performanceMode && <FloatingAchievementGraphics />}
          ...
          {achievementsData.map((achievement, index) => (
            ...
            >
              ...
              >
                ...
                {/* Top Corner Dot with Pulse - disable pulse in Performance Mode */}
                <motion.div
                ...
                {/* Icon with Enhanced Animation - static in Performance Mode */}
                <motion.div 
                ...
                >
                  ...
                  {/* Glow effect behind icon on hover - disable in Performance Mode */}
                  {!performanceMode && hoveredCard === achievement.id && (
                    <motion.div
