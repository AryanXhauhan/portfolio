        ...
        <motion.div
          ...
          style={{
            ...
            background: `radial-gradient(circle, ${
              i === 0 ? 'rgba(251, 191, 36, 0.05)' :
              i === 1 ? 'rgba(168, 85, 247, 0.05)' :
...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      {!performanceMode && <FloatingProjectGraphics />}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                >
                  ...
                  <div className="relative h-[400px] bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl overflow-hidden border border-slate-700">
                    {/* Animated Scan Lines - disable in Performance Mode */}
                    {!performanceMode && (
                      <motion.div
                        className="absolute inset-0 pointer-events-none"
                        style={{
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      {/* Golden Reflection Glow - disable in Performance Mode */}
                      {!performanceMode && (
                        <motion.div
