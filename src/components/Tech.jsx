...
const FloatingTechGraphics = () => {
  ...
  return (
    <>
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-20" style={{ willChange: "opacity" }}>
        <motion.line
      ...
      >
        ...
        <div className="mb-2">
          <div className="w-full bg-gray-700/50 rounded-full h-1.5 md:h-2 overflow-hidden">
            ...
            >
              {/* Shine effect: disabled inside performanceMode */}
              {!performanceMode && (
                <motion.div 
        ...
        {/* Pulse Dot: static in Performance Mode */}
        <motion.div 
          className="absolute top-2 right-2 w-2 h-2 rounded-full"
          style={{ backgroundColor: skill.color }}
          animate={performanceMode ? {} : { scale: [0.8, 1.2, 0.8] }}
...
const TechnologyStack = () => {
  ...
  return (
    ...
    >
      ...
      {/* Floating Technical Graphics - disable in Performance Mode */}
      {!performanceMode && <FloatingTechGraphics />}
      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 text-lg md:text-2xl max-w-4xl mx-auto">
