    ...
    <>
      ...
      {[...Array(25)].map((_, i) => (
        <motion.div
          ...
          style={{
            background: `linear-gradient(135deg, ${i % 3 === 0 ? '#a855f7' : i % 3 === 1 ? '#fbbf24' : '#f97316'
              }, transparent)`,
            top: `${Math.random() * 100}%`,
      ...
      {[...Array(3)].map((_, i) => (
        <motion.div
          ...
          style={{
            width: `${500 + i * 200}px`,
            height: `${500 + i * 200}px`,
            background: `radial-gradient(circle, ${i === 0 ? 'rgba(168, 85, 247, 0.05)' :
                i === 1 ? 'rgba(251, 191, 36, 0.05)' :
...
const AboutSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Enhanced Floating Graphics - Render only in visual mode */}
      {!performanceMode && <FloatingAboutGraphics />}
        ...
        <div className="flex flex-col md:flex-row justify-start items-start gap-6 mb-8 text-white">
          ...
          >
            <p className="text-lg leading-relaxed text-gray-200">
              ...
              <br /><br />
              In just <span className="text-orange-300 font-bold">three months</span>, I generated over <span className="text-orange-400 font-bold">₹2 lakhs</span> in revenue by developing and selling proprietary algorithmic trading indicators on <span className="text-yellow-400 font-bold">TradingView</span>, including <span className="text-purple-400 font-bold">AruAlgo v6 Pro</span>, <span className="text-purple-400 font-bold">v6.6 Pro</span>, and <span className="text-purple-400 font-bold">v6.7 Elite</span>. Through <span className="text-yellow-300 font-bold">Instagram marketing</span>, I built a community of <span className="text-orange-300 font-bold">2,000+</span> active traders while achieving <span className="text-yellow-400 font-bold">60-90% live market accuracy</span> across all indicators.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              {/* Border Glow: static in Eco Mode, animated in Visual Mode */}
              <motion.div
                className="absolute inset-0 rounded-3xl"
                style={{
                  background: 'linear-gradient(45deg, #fbbf24, #f97316, #a855f7, #fbbf24)',
                  backgroundSize: performanceMode ? 'auto' : '400% 400%',
                }}
