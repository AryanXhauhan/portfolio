...
const projectsData = [
  ...
  },
  {
    ...
    date: "September 2025 - Present",
    description:
      "Design-to-code SaaS platform that generates production-ready UI from design inputs. Converts user prompts/designs into HTML, CSS, and JS code with integrated secure authentication. Targets freelancers, agencies, and developers looking to dramatically reduce frontend development time. Pre-launch stage with vision to revolutionize UI development workflows.",
